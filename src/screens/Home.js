...
export default function Home({ navigation }) {
          ...
          return ekubLists.map((item, index) => {
               return (
                    <View key={index} style={{ backgroundColor: COLORS.secondary, marginHorizontal: 16, marginVertical: 20, borderRadius: 12 }}>
                         ...
                         <TouchableOpacity onPress={() => navigation.navigate("Ekub", { ekubId: item.id })} style={{ backgroundColor: COLORS.primary, marginHorizontal: 20, marginBottom: 20, padding: 10, borderRadius: 8, alignItems: 'center' }}>
                              <Text style={[styles.mediumTextAm, { color: COLORS.secondary }]}>ይቀጥሉ</Text>
                         </TouchableOpacity>
     ...
     return (
          <View style={{ flex: 1, }}>
               <LinearGradient colors={['#a9c8e9ff', '#1c785f', COLORS.primary]} style={{ flex: 1, }}>
                    <ScrollView>
                         ...
                         {isLoading === true ?
                              ...
                              <View style={{ paddingBottom: 50 }}>
                                   {ekubLists.length === 0 ?
                                        <>
                                             <View style={{ marginHorizontal: 30, marginBottom: 20, gap: 30 }}>
                                                  <Text style={[styles.largTextAm, { alignSelf: "center", fontSize: 24, color: COLORS.secondary }]}>እንኳን ደህና መጡ</Text>
                                                  <Text style={[styles.smallTextAm, { alignSelf: "center", color: COLORS.secondary }]}>
                                             ...
                                             {!isAgreed ?
                                                  <View style={{ marginHorizontal: 30 }}>
                                                       ...
                                                       <TouchableOpacity onPress={handleAccept} style={[styles.submitButtons, { marginHorizontal: 0, backgroundColor: COLORS.secondary }]}>
                                                            <Text style={styles.mediumTextAm}>ይቀጥሉ</Text>
                                                       </TouchableOpacity>
                                                  </View>
                                                  :
                                        ...
                                        :
                                        <>
                                             <Text style={[styles.mediumTextAm, { alignSelf: 'center', color: COLORS.secondary, marginBottom: 30 }]}>{ekubLists.length === 1 ? "የተጀመረ  እቁብ" : "የተጀመሩ  እቁቦች"}</Text>
                                             {showEkubList()}
                                        </>
                                   }
                              </View>
